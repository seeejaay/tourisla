        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredReports.map((report) => (
            <ViewIncident
              ...
              report={{
                ...report,
                submitted_by: report.submitted_by === null ? undefined : report.submitted_by,
                photo_url: report.photo_url === null ? undefined : report.photo_url,
                submitted_at: report.submitted_at === null ? undefined : report.submitted_at,
              }}
            />
          ))}
        </div>
