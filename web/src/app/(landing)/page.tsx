...
export default function Home() {
  return (
    <>
      <Header />
      <main className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-white via-blue-50 to-blue-100 ">
        <section className=" text-center max-w-xl">
          <h1 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-blue-400 mb-4 tracking-tight">
            TourIsla
          </h1>
          <p className="text-lg text-gray-500 mb-10 font-light">
            Discover the beauty of the islands. Plan your next adventure with
            us!
          </p>
          <a
            href="#explore"
