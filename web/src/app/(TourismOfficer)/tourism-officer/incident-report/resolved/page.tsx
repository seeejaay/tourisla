    ...
    <main className="flex flex-col min-h-screen w-full bg-gradient-to-br from-[#e6f7fa] via-white to-[#b6e0e4] px-2 py-8">
      <div className="w-full max-w-6xl mx-auto flex flex-col items-center gap-6">
        ...
        <div className="w-full flex flex-col items-center gap-2">
          <h1 className="text-4xl font-extrabold text-center text-green-700 tracking-tight">
        ...
        <div className="w-full flex flex-col md:flex-row gap-4 mb-6 items-center justify-between">
          <input
            ...
            className="w-full md:w-1/2 border border-[#e6f7fa] px-4 py-2 rounded-lg shadow-sm focus:ring-2 focus:ring-green-400 focus:border-green-400 transition"
          />

          <select
            value={typeFilter}
            onChange={(e) => setTypeFilter(e.target.value)}
            className="w-full md:w-1/3 border border-[#e6f7fa] px-4 py-2 rounded-lg shadow-sm focus:ring-2 focus:ring-green-400 focus:border-green-400 transition"
          >
