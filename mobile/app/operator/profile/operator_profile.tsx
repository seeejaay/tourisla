      ...
      >
        ...
        {user && (
          <View style={styles.profileCard}>
            ...
            {/* Role Badge */}
            <View style={[styles.roleBadge, user?.role === 'Tour Operator' ? styles.operatorBadge : styles.userBadge]}>
              <Text style={[styles.roleText, user?.role !== 'Tour Operator' && styles.userRoleText]}>
