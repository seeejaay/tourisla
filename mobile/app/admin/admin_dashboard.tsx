  ...
  useEffect(() => {
    const fetchCurrentUser = async () => {
      try {
        ...
        if (!storedUser) {
          console.warn("Admin Dashboard: No stored user found");
        ...
        try {
          ...
          console.error(
            "Admin Dashboard: Failed to parse user data:",
            parseError,
          );
        ...
        if (!userData || !userData.role) {
          console.warn("Admin Dashboard: Invalid user data");
          ...
          try {
            ...
            console.error(
              "Admin Dashboard: Failed to recover user data:",
              apiError,
            );
          }
...
const styles = StyleSheet.create({
  ...
  headerContainer: {
    ...
    height:
      70 + (Platform.OS === "android" ? StatusBar.currentHeight || 0 : 44),
    width: "100%",
    flexDirection: "row",
    alignItems: "center",
