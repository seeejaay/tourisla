...
export default function IslandEntryCheckInScreen() {
  ...
  const lookupInput = code.trim().match(/^[A-Z0-9]+$/) // adjust this regex for your unique_code format
        ...
        {result && (
          <View style={styles.resultBox}>
            <Text style={styles.receiptTitle}>
              ISLAND ENTRY CODE: {result.registration.unique_code}{" "}
            </Text>
            ...
            >
              ...
              <View style={styles.detailRow}>
                ...
                <Text style={styles.receiptValue}>
                  {toTitleCase(result.registration.payment_method)}
                </Text>
              </View>
              ...
              <View style={styles.detailRow}>
                ...
                <Text style={styles.receiptValue}>
                  {toTitleCase(result.registration.status)}
                </Text>
              </View>
            ...
            <Text
              style={[
                styles.receiptLabel,
                { fontWeight: "600", fontSize: 16, marginTop: 12 },
              ]}
            >
              Group Members
            </Text>
              ...
              >
                <View style={styles.memberHeader}>
                  <Text
                    style={
                      (styles.label,
                      { fontWeight: "700", color: "#42837b", fontSize: 12 })
                    }
                  >
                    {idx + 1}. {m.name}
                  </Text>
